...
echo "<script>alert('username tidak boleh kosong');location.href='tambah-siswa.php';</script>";
...
if($insert){
echo "<script>alert('Sukses menambahkan siswa');location.href='tambah-siswa.php';</script>";
} else {
