...
(1, 'Black Clover', 'Black Clover', 0x502e6a7067);
...
(1, 1, '2022-09-13', '2022-09-18'),
(2, 1, '2022-09-13', '2022-09-18');
...
(1, 'Angga', '2022-09-03', 'L', 'malang', 'Angga', '827ccb0eea8a706c4c34a16891f84e7b', 6);
...
ALTER TABLE `detail_peminjaman_buku`
  ...
  ADD KEY `id_peminjaman_buku_3` (`id_peminjaman_buku`),
