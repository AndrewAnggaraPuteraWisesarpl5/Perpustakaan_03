...
if(empty($nama_siswa)){
echo "<script>alert('nama siswa tidak boleh kosong');location.href='daftar.php';</script>";
...
if($insert){
echo "<script>alert('Sukses menambahkan siswa');location.href='daftar.php';</script>";
} else {
echo "<script>alert('Gagal menambahkan siswa');location.href='daftar.php';</script>";
}
}
}
?>